...
var Main = function () {
    ...
    var settingsHandler = function () {
        ...
        $('#skin_color').attr("href", "/styles/themes/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function () {
            ...
            $('#skin_color').attr("href", "/styles/themes/" + selectedTheme + ".css");
        ...
        function defaultSetting() {
            ...
            $('#skin_color').attr("href", "/styles/themes/theme-1.css");
            $(".navbar-brand img").attr("src", "/images/logo.png");
